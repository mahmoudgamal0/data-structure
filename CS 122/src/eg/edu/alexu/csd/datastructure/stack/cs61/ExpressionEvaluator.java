...
public class ExpressionEvaluator implements IExpressionEvaluator{
	 ...
	 * @param expression the infix notation to be changed
	 * @throws null if the expression is null
	 ...
	 * @param expression the notation to be evaluated
	 * @return the value of evaluation
	 * @throws null if the expression is not correct
	 * if the expression is symbolic
	 */
	 ...
	 * @param c character in the expression
	 ...
	 * @param inStack the operation in the stack
	 * @param scanned the operation compared to the top of the stack
	...
	/**
	 * checks whether the provided expression is correct for the infixToPostfix process
	 * @param expression the expression to be checked
	 * @throws null if the expression is null
	 * if it has wrong parenthesis
	 * if there is unary operators in the expression
	 */
	 ...
	 * @throws null if it is a symbolic expression
	 * if it has unary operators
	 * if it has different symbols than digits and arithmetic operations
	 */
	...
	/**
	 * checks whether the character belongs to the category of arithmetic operations and parenthesis or not 
	...
	/**
	 * checks if the character in this location belongs to the previous character to form a single multi-digit number
	 * @param expression the expression to be checked
	 ...
	 * @param expression the expression to get the numerical value of
	...
	/**
	 * checks if the expression has extra operators, unary operators, or lacks operators
	 * @param expression
	 * @return true if it is correct
	 * @returns false if it has an error between the literals and operations numbers
	 */
